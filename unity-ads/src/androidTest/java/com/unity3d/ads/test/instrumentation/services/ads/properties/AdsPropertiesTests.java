...
public class AdsPropertiesTests {
	...
	public void testInitializeMultipleListeners() {
		...
		UnityAds.initialize(_activityRule.getActivity(), "4169571", listener1);
		UnityAds.initialize(_activityRule.getActivity(), "4169571", listener2);
	...
	public void testSetOverwriteInit() {
		...
		UnityAds.initialize(_activityRule.getActivity(), "4169571", listener1);
		UnityAds.setListener(listener2);
		UnityAds.initialize(_activityRule.getActivity(), "4169571", listener3);
