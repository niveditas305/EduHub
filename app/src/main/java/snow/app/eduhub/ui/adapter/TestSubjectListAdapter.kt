...
class TestSubjectListAdapter(var contxt: Context, var list: List<Data>) :
    RecyclerView.Adapter<TestSubjectListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TestSubjectListAdapter.MyViewHolder, position: Int) {
        ...
        holder.container.setOnClickListener {
            var intent = Intent(contxt, TestListActivity::class.java)
