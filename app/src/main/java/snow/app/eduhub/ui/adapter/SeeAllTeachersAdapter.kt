...
class SeeAllTeachersAdapter(
    var contxt: Context,
    var list: List<TopTeacher>/*, var subjectId: String*/,
    var listener: LikeDislikeListener
) :
    RecyclerView.Adapter<SeeAllTeachersAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.tv_exp.setText(list.get(position).teacherExpirence.toString() + " years Experience")
