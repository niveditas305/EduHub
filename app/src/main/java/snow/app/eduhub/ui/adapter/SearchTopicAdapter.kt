...
import snow.app.eduhub.ui.network.responses.searchres.TopicData
import java.util.ArrayList

class SearchTopicAdapter(
    var contxt: Context, var list: List<TopicData>, var mainActivity: SearchScreen
) :
    RecyclerView.Adapter<SearchTopicAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.row_topic_search, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.rl_parent.setOnClickListener {
            ...
            mainActivity.viewModel.resprecentContinueTopic(
                list.get(position).chapterId.toString(),
                list.get(position).subjectId.toString(),
                list.get(position).teacherId.toString()
            )
