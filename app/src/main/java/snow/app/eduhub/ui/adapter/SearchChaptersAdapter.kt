...
import snow.app.eduhub.ui.network.responses.searchres.Chapter
import snow.app.eduhub.ui.network.responses.searchres.Topic


class SearchChaptersAdapter(var contxt: Context, var list: List<Chapter>) :
    RecyclerView.Adapter<SearchChaptersAdapter.MyViewHolder>() {
    ...
    fun setTopicAdapter(rv_topics: RecyclerView, list: List<Topic>) {
        ...
        val topicsAdapter = SearchTopicsAdapter(contxt, list)
